...
private double dineroPerdido;
    ...
    public Jugador(Long id, String nickname, Double dinero, int victoriasM1, int derrotasM1, int victoriasM2, int derrotasM2, int victoriasM3, int derrotasM3, int vTotales, int dTotales, int nApuestas, double dineroGanado, double dineroPerdido) {
        this.id = id;
